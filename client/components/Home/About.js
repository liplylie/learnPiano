      ...
      >
        ...
        <div className="row">
          <div className="col-md-12 text-center" style={{ fontSize: "2em" }}>
            ...
            <p>
              Learn Piano Fun is a website for interactively learning how to
              play the{" "}
            ...
            <p>
              Even if you do not own a piano, that's ok! With the built in
              piano, you can still play through the app. (Piano is built by{" "}
