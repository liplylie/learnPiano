...
class LightlyRow extends Component {
    constructor(props) {
        super(props);
        this.state = {
            correctNote: null,
        ...
        this.start = false;
        this.songName = "LightlyRow";
        this.lessonNotes = "G4 E4 E4 F4 D4 D4 C4 D4 E4 F4 G4 G4 G4 G4 E4 E4 F4 D4 D4 C4 E4 G4 G4 C4".split(" ");
        this.popUpCount = 1;
...
const LightlyRowMapStateToProps = store => {
    return {
        Auth: store.Auth,
...
export default connect(LightlyRowMapStateToProps, LightlyRowDispatch)(
    LightlyRow
);