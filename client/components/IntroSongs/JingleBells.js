...
class JingleBells extends Component {
    constructor(props) {
        super(props);
        this.state = {
            correctNote: null,
                ...
                >
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            >
                                {" "}
                                Congrats! You have played through Jingle Bells<br />{" "}
                                <img
...
const JingleBellsMapStateToProps = store => {
    return {
        Auth: store.Auth,
...
const JingleBellsDispatch = dispatch => {
    return {
...
export default connect(JingleBellsMapStateToProps, JingleBellsDispatch)(
    JingleBells
);