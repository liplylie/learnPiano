...
class LoveSomebody extends Component {
    constructor(props) {
        super(props);
        this.state = {
            correctNote: null,
        ...
        this.start = false;
        this.songName = "LoveSomebody";
        this.lessonNotes = "C4 E4 G4 G4 D4 E4 F4 C4 E4 G4 G4 F4 E4 D4 C4 E4 G4 G4 D4 E4 F4 E4 E4 D4 D4 C4 C4 C4".split(" ");
        this.popUpCount = 1;
                ...
                >
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            >
                                {" "}
                                Congrats! You have played through Love Somebody<br />{" "}
                                <img
...
const LoveSomebodyMapStateToProps = store => {
    return {
        Auth: store.Auth,
...
export default connect(LoveSomebodyMapStateToProps, LoveSomebodyDispatch)(
    LoveSomebody
);