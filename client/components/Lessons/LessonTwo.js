...
class LessonTwo extends Component {
    ...
    componentDidUpdate() {
        if (
            ...
            document.getElementById(
                `lessonTwoButton${this.state.buttonToShow}`
            ).style.display =
                "block";
            this.popUpCount += 1;
            this.correctAnswers += 1;
            ...
            Popup.alert(
                <div style={{ fontFamily: "helvetica", fontSize: "2.5em" }}>
                    ...
                    />{" "}
                    Incorrect! You played a {this.state.wrongNote[0]}
                </div>
            );
        }
    }
    ...
    lessonTwoButtonTwo() {
        ...
        document.getElementById("lessonTwoMessageThree").style.display =
            "block";
        this.setState({
            checkNote: "C4",
            buttonToShow: "Three"
    ...
    lessonTwoButtonSix() {
        ...
        document.getElementById("lessonTwoMessageSeven").style.display =
            "block";
        this.setState({
            checkNote: "A3",
            buttonToShow: "Seven"
    ...
    lessonTwoButtonSeven() {
        ...
        document.getElementById("lessonTwoMessageEight").style.display =
            "block";
    ...
    lessonTwoButtonTen() {
        ...
        document.getElementById("lessonTwoMessageEleven").style.display =
            "block";
        this.setState({
            checkNote: "F3",
            buttonToShow: "Eleven"
    ...
    lessonTwoButtonEleven() {
        ...
        document.getElementById("lessonTwoMessageTwelve").style.display =
            "block";
        document.getElementById("lessonTwoButtonTwelve").style.display =
            "block";
    }
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div
                                ...
                                id="lessonTwoMessageOne"
                            >
                                {" "}
                                Welcome back! Get ready for Lesson 2! Today we
                                will learn 5 more notes!
                            </div>
                            <button
                                id="lessonTwoButtonOne"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonOne()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageTwo"
                            >
                                {" "}
                                We'll look at middle C. However, this time,
                                middle C is in the bass Clef. For now, assume
                                that whatever is played in the bass clef is
                                played in the left hand. Look at the image to
                                determine where middle C is located on your
                                piano. <br />{" "}
                                <img
                            ...
                            <button
                                ...
                                id="lessonTwoButtonTwo"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonTwo()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageThree"
                            >
                                {" "}
                                When you find it, play Middle C with your left
                                hand <br />
                                <img
                                    style={{ height: "12em", width: "15em" }}
                                    src={require("../../static/leftHandPianoHome1.jpg")}
                                />
                                <br />
                            </div>
                            <button
                                ...
                                id="lessonTwoButtonThree"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonThree()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageFour"
                            >
                                {" "}
                                Excellent! Let's move on to the next note! The
                                white key to the left of C is B. <br />{" "}
                                <img
                                    style={{ height: "50vh", width: "60vw" }}
                                    src={require("../../static/findB.jpg")}
                                />
                                <br />
                            </div>
                            <button
                                ...
                                id="lessonTwoButtonFour"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonFour()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            ...
                            <button
                                ...
                                id="lessonTwoButtonFive"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonFive()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageSix"
                            >
                                {" "}
                                Good Work! After B, the next white key to the
                                left is an A <br />{" "}
                                <img
                                    style={{ height: "50vh", width: "60vw" }}
                                    src={require("../../static/findA.jpg")}
                                />
                                <br />
                            </div>
                            <button
                                ...
                                id="lessonTwoButtonSix"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonSix()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            ...
                            <button
                                ...
                                id="lessonTwoButtonSeven"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonSeven()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageEight"
                            >
                                {" "}
                                Super! The next note to the left is F! <br />{" "}
                                <img
                                    style={{ height: "50vh", width: "60vw" }}
                                    src={require("../../static/findG.jpg")}
                                />
                                <br />
                            </div>
                            <button
                                ...
                                id="lessonTwoButtonEight"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonEight()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            ...
                            <button
                                ...
                                id="lessonTwoButtonNine"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonNine()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageTen"
                            >
                                {" "}
                                Great! The last note for this lesson is F.
                                Please find F. <br />{" "}
                                <img
                                    style={{ height: "50vh", width: "60vw" }}
                                    src={require("../../static/findF.jpg")}
                                />
                                <br />
                            </div>
                            <button
                                ...
                                id="lessonTwoButtonTen"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonTen()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            ...
                            <button
                                ...
                                id="lessonTwoButtonEleven"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonEleven()}
                            >
                                {" "}
                                next{" "}
                            </button>
                            <div
                                ...
                                id="lessonTwoMessageTwelve"
                            >
                                {" "}
                                Congrats! You have learned how to play your
                                first five notes with your left hand. Please
                                continue to lesson three! <br />{" "}
                                <img
                                    style={{ height: "50vh", width: "60vw" }}
                            ...
                            <button
                                ...
                                id="lessonTwoButtonTwelve"
                                className="btn btn-primary"
                                onClick={() => this.lessonTwoButtonTwelve()}
                            >
                                {" "}
                                Finish{" "}
                            </button>
