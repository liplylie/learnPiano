        ...
        <div className="row">
          <div className="col-md-12">
            ...
            >
              <p>
                {" "}
                Rules: Notes will flash on the screen. Play the correct note as
                fast as you can for thirty seconds! And try to beat your high
                score!
              </p>
              <img
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <img
              ...
              src={this.state.notePicture[this.state.guessNote]}
            />
          </div>
          <div className="col-md-4">
            <img
