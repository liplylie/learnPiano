...
class SaintsGoMarchin extends Component {
  ...
  lessonThreeButtonTwo() {
    ...
    document.getElementById("lessonThreeMessageThree").style.display = "block";
    this.setState({
        ...
        >
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              >
                {" "}
                Congrats! You have played through When the Saints Go Marchin
                <br />{" "}
                <img
...
export default connect(
  SaintsGoMarchinMapStateToProps,
  SaintsGoMarchinDispatch
)(SaintsGoMarchin);
