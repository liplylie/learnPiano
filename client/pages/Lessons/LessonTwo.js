      ...
      if (
        ...
        if (that.noteArray.length === 3) {
          if (that.noteArray.includes(matchNote)) {
            ...
            that.noteArray = [];
            if (
              document.getElementsByClassName("mm-popup__btn mm-popup__btn--ok")
            ) {
        ...
        >
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              >
                {" "}
                Welcome back! Get ready for Lesson 2! Today we will learn 5 more
                notes!
              </div>
              <button
              ...
              >
                {" "}
                We'll look at middle C. However, this time, middle C is in the
                bass Clef. For now, assume that whatever is played in the bass
                clef is played in the left hand. Look at the image to determine
                where middle C is located on your piano. <br />{" "}
                <img
                  style={{ height: "50vh", width: "60vw" }}
                  src={`${secret.SampleUrl}/static/findMiddleC.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                {" "}
                When you find it, play Middle C with your left hand <br />
                <img
                  style={{ height: "12em", width: "15em" }}
                  src={`${secret.SampleUrl}/static/leftHandPianoHome1.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                {" "}
                Excellent! Let's move on to the next note! The white key to the
                left of C is B. <br />{" "}
                <img
                  style={{ height: "50vh", width: "60vw" }}
                  src={`${secret.SampleUrl}/static/findB.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                {" "}
                Good Work! After B, the next white key to the left is an A{" "}
                <br />{" "}
                <img
                  style={{ height: "50vh", width: "60vw" }}
                  src={`${secret.SampleUrl}/static/FindA.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                ...
                <img
                  style={{ height: "50vh", width: "60vw" }}
                  src={`${secret.SampleUrl}/static/findG.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                {" "}
                Great! The last note for this lesson is F. Please find F. <br />{" "}
                <img
                  style={{ height: "50vh", width: "60vw" }}
                  src={`${secret.SampleUrl}/static/findF.jpg`}
                />
                <br />
              </div>
              <button
              ...
              >
                {" "}
                Congrats! You have learned how to play your first five notes
                with your left hand. Please continue to lesson three! <br />{" "}
                <img
                  style={{ height: "50vh", width: "60vw" }}
          ...
          <div id="showPiano" style={{ display: "none" }}>
            <Piano />
            <p onClick={() => this.hidePiano()} style={{ cursor: "pointer" }}>
              {" "}
              hide
            </p>
          </div>
